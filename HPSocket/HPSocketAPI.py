...
if hasattr(HPSocketDLL, "HP_Server_IsConnected"):
    HP_Server_IsConnected = HPSocketDLL.HP_Server_IsConnected
    HP_Server_IsConnected.restype = ctypes.c_bool
    HP_Server_IsConnected.argtypes = [HP_Server, HP_CONNID]
...
if hasattr(HPSocketDLL, "HP_Agent_ConnectWithLocalPort"):
    HP_Agent_ConnectWithLocalPort = HPSocketDLL.HP_Agent_ConnectWithLocalPort
    HP_Agent_ConnectWithLocalPort.restype = ctypes.c_bool
    HP_Agent_ConnectWithLocalPort.argtypes = [HP_Agent, ctypes.c_char_p, ctypes.c_ushort, ctypes.POINTER(HP_CONNID), ctypes.c_ushort]
...
if hasattr(HPSocketDLL, "HP_Agent_ConnectWithExtraAndLocalPort"):
    HP_Agent_ConnectWithExtraAndLocalPort = HPSocketDLL.HP_Agent_ConnectWithExtraAndLocalPort
    HP_Agent_ConnectWithExtraAndLocalPort.restype = ctypes.c_bool
    HP_Agent_ConnectWithExtraAndLocalPort.argtypes = [HP_Agent, ctypes.c_char_p, ctypes.c_ushort, ctypes.POINTER(HP_CONNID), PVOID, ctypes.c_ushort]
...
if hasattr(HPSocketDLL, "HP_Agent_IsConnected"):
    HP_Agent_IsConnected = HPSocketDLL.HP_Agent_IsConnected
    HP_Agent_IsConnected.restype = ctypes.c_bool
    HP_Agent_IsConnected.argtypes = [HP_Agent, HP_CONNID]
...
if hasattr(HPSocketDLL, "HP_Client_StartWithBindAddressAndLocalPort"):
    HP_Client_StartWithBindAddressAndLocalPort = HPSocketDLL.HP_Client_StartWithBindAddressAndLocalPort
    HP_Client_StartWithBindAddressAndLocalPort.restype = ctypes.c_bool
    HP_Client_StartWithBindAddressAndLocalPort.argtypes = [HP_Client, ctypes.c_char_p, ctypes.c_ushort, ctypes.c_bool, ctypes.c_char_p, ctypes.c_ushort]
...
if hasattr(HPSocketDLL, "HP_Client_IsConnected"):
    HP_Client_IsConnected = HPSocketDLL.HP_Client_IsConnected
    HP_Client_IsConnected.restype = ctypes.c_bool
    HP_Client_IsConnected.argtypes = [HP_Client]
...
if hasattr(HPSocketDLL, "SYS_SSO_ExclusiveAddressUse"):
    SYS_SSO_ExclusiveAddressUse = HPSocketDLL.SYS_SSO_ExclusiveAddressUse
    SYS_SSO_ExclusiveAddressUse.restype = ctypes.c_int
    SYS_SSO_ExclusiveAddressUse.argtypes = [SOCKET, ctypes.c_bool]
...
if hasattr(HPSocketDLL, "SYS_Malloc"):
    SYS_Malloc = HPSocketDLL.SYS_Malloc
    SYS_Malloc.restype = LPBYTE
    SYS_Malloc.argtypes = [ctypes.c_int]

#  重新分配内存
# HPSOCKET_API LPBYTE __HP_CALL SYS_Realloc(LPBYTE p, int size);
if hasattr(HPSocketDLL, "SYS_Realloc"):
    SYS_Realloc = HPSocketDLL.SYS_Realloc
    SYS_Realloc.restype = LPBYTE
    SYS_Realloc.argtypes = [LPBYTE, ctypes.c_int]

#  释放内存
# HPSOCKET_API VOID __HP_CALL SYS_Free(LPBYTE p);
if hasattr(HPSocketDLL, "SYS_Free"):
    SYS_Free = HPSocketDLL.SYS_Free
    SYS_Free.argtypes = [LPBYTE]
...
# typedef En_HP_HandleResult	 (__HP_CALL *HP_FN_Http_OnWSMessageHeader)	(HP_Http pSender, HP_CONNID dwConnID, BOOL bFinal, BYTE iReserved, BYTE iOperationCode, const int lpszMask, ULONGLONG ullBodyLen);
...
# *			FALSE			-- 失败
#
# HPSOCKET_API BOOL __HP_CALL HP_HttpServer_SendWSMessage(HP_HttpServer pServer, HP_CONNID dwConnID, BOOL bFinal, BYTE iReserved, BYTE iOperationCode, const int lpszMask, BYTE* pData, int iLength, ULONGLONG ullBodyLen);
...
# *			FALSE			-- 失败
#
# HPSOCKET_API BOOL __HP_CALL HP_HttpAgent_SendWSMessage(HP_HttpAgent pAgent, HP_CONNID dwConnID, BOOL bFinal, BYTE iReserved, BYTE iOperationCode, const int lpszMask, BYTE* pData, int iLength, ULONGLONG ullBodyLen);
...
# *			FALSE			-- 失败
#
# HPSOCKET_API BOOL __HP_CALL HP_HttpClient_SendWSMessage(HP_HttpClient pClient, BOOL bFinal, BYTE iReserved, BYTE iOperationCode, const int lpszMask, BYTE* pData, int iLength, ULONGLONG ullBodyLen);
